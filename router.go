...
// Controller is the function can be registered
// note: Controller and HandleFunc are different
type Controller func(*Context)

type routes map[string]map[string]Controller
...
func (m *Moe) register(method, pattern string, f Controller) *Moe {
